...
import { ShelterRegistrationModalComponent } from '../modals/shelter-registration-modal/shelter-registration-modal.component';

@Component({
  selector: 'app-about',
  imports: [RouterLink, ShelterRegistrationModalComponent],
